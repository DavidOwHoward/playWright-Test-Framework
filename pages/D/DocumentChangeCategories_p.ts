...
export class DocumentChangeCategories_p extends DetailsPageBase {
  get CategoryName() {

    const { root, section } = this.fieldRootInSection(`CategoryName_f`, `General`);
  ...
  get ChangeChecklist() {
    ...
    const { root, section } = this.fieldRootInSection(`ChangeChecklist_f`, `General`);
