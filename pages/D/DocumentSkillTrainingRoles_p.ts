...
export class DocumentSkillTrainingRoles_p extends DetailsPageBase {
  get Document() {
  ...
  get TrainingRolesfromSkillType() {

    const { root, section } = this.fieldRootInSection(`TrainingRolesfromSkillType_f`, `General`);
