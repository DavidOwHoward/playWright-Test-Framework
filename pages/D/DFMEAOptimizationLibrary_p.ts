...
export class DFMEAOptimizationLibrary_p extends DetailsPageBase {
  ...
  get DFMEADetectionAction() {
    ...
    const { root, section } = this.fieldRootInSection(`DFMEADetectionAction_f`, `General`);
  ...
  get DFMEACauseLibrary() {

    const { root, section } = this.fieldRootInSection(`DFMEACauseLibrary_f`, `General`);
  ...
  get _ResidualDetectionD() {
    ...
    const { root, section } = this.fieldRootInSection(`ResidualDetectionD_f`, `General`);
  ...
  get _ResidualOccurrenceO() {
    ...
    const { root, section } = this.fieldRootInSection(`ResidualOccurrenceO_f`, `General`);
  ...
  get _ResidualSeverityS() {
    ...
    const { root, section } = this.fieldRootInSection(`ResidualSeverityS_f`, `General`);
