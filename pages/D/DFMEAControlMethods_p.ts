...
export class DFMEAControlMethods_p extends DetailsPageBase {
  get _sDetectionPreventionatleastonecheckedfield() {

    const { root, section } = this.fieldRootInSection(`sDetectionPreventionatleast_f`, `General`);
