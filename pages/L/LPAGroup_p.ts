...
export class LPAGroup_p extends DetailsPageBase {
  get Title() {
  ...
  get Audits() {
    ...
    const { root, section } = this.fieldRootInSection(`Audits_f`, `General`);
  ...
  get _Layers() {
    ...
    const { root, section } = this.fieldRootInSection(`Layers_f`, `General`);
