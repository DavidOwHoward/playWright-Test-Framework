...
export class LibrarySpecifications_p extends DetailsPageBase {
  ...
  get ChangeSummary() {
    ...
    const { root, section } = this.fieldRootInSection(`ChangeSummary_f`, `General`);
  ...
  get _MultiLinkedSpecWarning() {

    const { root, section } = this.fieldRootInSection(`MultiLinkedSpecWarning_f`, `General`);
