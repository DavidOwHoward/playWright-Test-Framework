...
export class Workflow_p extends DetailsPageBase {
  get ActionTaken() {
  ...
  get _AddAdhocTask() {
    ...
    const { root, section } = this.fieldRootInSection(`AddAdhocTask_f`, `General`);

    return new CheckboxField(this.page, root, async () => section.openAndWait(root));
  }

  get AllAdhocTasksCompleted() {

    const { root, section } = this.fieldRootInSection(`AllAdhocTasksCompleted_f`, `General`);
  ...
  get AdhocTaskSelection() {

    const { root, section } = this.fieldRootInSection(`AdhocTaskSelection_f`, `General`);
  ...
  get Issue() {
    ...
    const { root, section } = this.fieldRootInSection(`Issue_f`, `General`);
  ...
  get Library() {
    ...
    const { root, section } = this.fieldRootInSection(`Library_f`, `General`);
