...
export class WorkCenters_p extends DetailsPageBase {
  get WorkCenterCode() {
  ...
  get WorkCenterName() {
    ...
    const { root, section } = this.fieldRootInSection(`WorkCenterName_f`, `General`);
  ...
  get AssociatedEquipment() {

    const { root, section } = this.fieldRootInSection(`AssociatedEquipment_f`, `Equipment`);
