...
export class AdhocTasksLibrary_p extends DetailsPageBase {
  get CalculateFrom() {
  ...
  get NumberofDaystoCompleteTask() {

    const { root, section } = this.fieldRootInSection(`NumberofDaystoCompleteTask_f`, `General`);
  ...
  get WorkflowLibrary() {
    ...
    const { root, section } = this.fieldRootInSection(`WorkflowLibrary_f`, `General`);
