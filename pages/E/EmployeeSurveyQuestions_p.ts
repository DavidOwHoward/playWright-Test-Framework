...
export class EmployeeSurveyQuestions_p extends DetailsPageBase {
  get Question() {
  ...
  get QuestionAutoNumber() {
    ...
    const { root, section } = this.fieldRootInSection(`QuestionAutoNumber_f`, `General`);
  ...
  get ResponseChoices() {
    ...
    const { root, section } = this.fieldRootInSection(`ResponseChoices_f`, `General`);
