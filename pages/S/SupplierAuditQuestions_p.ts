...
export class SupplierAuditQuestions_p extends DetailsPageBase {
  get QuestionNumber() {
  ...
  get _SupplierAuditChecklists() {

    const { root, section } = this.fieldRootInSection(`SupplierAuditChecklists_f`, `Links`);
