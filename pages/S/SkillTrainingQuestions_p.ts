...
export class SkillTrainingQuestions_p extends DetailsPageBase {
  get AdditionalReferenceInformation() {

    const { root, section } = this.fieldRootInSection(`AdditionalReferenceInformat_f`, `General`);
  ...
  get AnswerChoices() {
    ...
    const { root, section } = this.fieldRootInSection(`AnswerChoices_f`, `General`);
