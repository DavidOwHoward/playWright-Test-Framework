...
export class SupplierAuditTeamMembers_p extends DetailsPageBase {
  get Auditor() {
  ...
  get TeamMemberType() {
    ...
    const { root, section } = this.fieldRootInSection(`TeamMemberType_f`, `General`);
  ...
  get AuditNumber() {
    ...
    const { root, section } = this.fieldRootInSection(`Audit_f`, `Audit Information`);
