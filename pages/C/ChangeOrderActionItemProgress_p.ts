...
export class ChangeOrderActionItemProgress_p extends DetailsPageBase {
  get _NoteDateTime() {
  ...
  get ChangeOrderActionItem() {

    const { root, section } = this.fieldRootInSection(`ChangeOrderActionItem_f`, `General`);
