...
export class CapacityPlanningVolumes_p extends DetailsPageBase {
  get AnnualCPVQuantity() {

    const { root, section } = this.fieldRootInSection(`AnnualCPVQuantity_f`, `General`);
  ...
  get PercentIncrease() {
    ...
    const { root, section } = this.fieldRootInSection(`PercentIncrease_f`, `General`);
  ...
  get FPVYear() {
    ...
    const { root, section } = this.fieldRootInSection(`FPVYear_f`, `General`);
