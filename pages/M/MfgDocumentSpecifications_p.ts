...
export class MfgDocumentSpecifications_p extends DetailsPageBase {
  get ToleranceMismatch() {

    const { root, section } = this.fieldRootInSection(`ToleranceMismatch_f`, `[Frozen Section]`);
  ...
  get _ApprovalofPassThroughCharacteristic() {

    const { root, section } = this.fieldRootInSection(`ApprovalofPassThroughCharac_f`, `General`);
  ...
  get CpK() {
    ...
    const { root, section } = this.fieldRootInSection(`CpK_f`, `General`);
  ...
  get _SysUtilizedonControlPlan() {

    const { root, section } = this.fieldRootInSection(`UtilizedonControlPlan_f`, `General`);
  ...
  get DrawingFeature() {
    ...
    const { root, section } = this.fieldRootInSection(`DrawingFeature_f`, `General`);
  ...
  get CustomerUnitofMeasure() {

    const { root, section } = this.fieldRootInSection(`CustomerUnitofMeasure_f`, `Tolerance`);
