...
export class MfgDocumentPFMEAControls_p extends DetailsPageBase {
  ...
  get ImplementationDate() {
    ...
    const { root, section } = this.fieldRootInSection(`ImplementationDate_f`, `General`);
  ...
  get _ProductProcessSpecificationTolerance() {

    const { root, section } = this.fieldRootInSection(`ProductProcessSpecification_f`, `General`);
  ...
  get References() {
    ...
    const { root, section } = this.fieldRootInSection(`References_f`, `General`);
  ...
  get ShowonWorkInstruction() {

    const { root, section } = this.fieldRootInSection(`ShowonWorkInstruction_f`, `General`);
  ...
  get Destructive() {
    ...
    const { root, section } = this.fieldRootInSection(`Destructive_f`, `Sampling & Inspection`);
  ...
  get _PreLaunch() {
    ...
    const { root, section } = this.fieldRootInSection(`PreLaunch_f`, `Sampling & Inspection`);
  ...
  get SafeLaunch() {
    ...
    const { root, section } = this.fieldRootInSection(`SafeLaunch_f`, `Sampling & Inspection`);
  ...
  get _VisualAidsDescription() {
    ...
    const { root, section } = this.fieldRootInSection(`VisualAidDescription1_f`, `Visual Aid`);
  ...
  get LibraryControl() {
    ...
    const { root, section } = this.fieldRootInSection(`SYSLibrarySourceRecordId_f`, `[Frozen Section]`);
  ...
  get Specification() {
    ...
    const { root, section } = this.fieldRootInSection(`Specfication_f`, `General`);
