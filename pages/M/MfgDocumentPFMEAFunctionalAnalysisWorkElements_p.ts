...
export class MfgDocumentPFMEAFunctionalAnalysisWorkElements_p extends DetailsPageBase {
  ...
  get MfgDocumentPFMEAFunctionalAnalysis() {

    const { root, section } = this.fieldRootInSection(`MfgDocumentPFMEAFunctionalA_f`, `General`);
