...
export class MfgDocumentDFMEAFunctionalAnalysis_p extends DetailsPageBase {
  ...
  get DFMEAFunctionalAnalysisLibrary() {

    const { root, section } = this.fieldRootInSection(`DFMEAFunctionalAnalysisLibr_f`, `[Frozen Section]`);
