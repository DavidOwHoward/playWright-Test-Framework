...
export class MfgDocumentPFMEAFunctionalAnalysis_p extends DetailsPageBase {
  ...
  get _FunctionofProcessItemSystemsubsystemShiptoPlant() {
    ...
    const { root, section } = this.fieldRootInSection(`FunctionofProcessItemEU_f`, `General`);
