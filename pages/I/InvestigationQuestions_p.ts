...
export class InvestigationQuestions_p extends DetailsPageBase {
  get InvestigationQuestion() {

    const { root, section } = this.fieldRootInSection(`InvestigationQuestion_f`, `General`);
  ...
  get InvestigationIncidentTypes() {

    const { root, section } = this.fieldRootInSection(`IncidentTypes_f`, `Investigation Types`);
