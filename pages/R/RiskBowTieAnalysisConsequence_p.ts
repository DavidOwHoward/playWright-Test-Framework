...
export class RiskBowTieAnalysisConsequence_p extends DetailsPageBase {
  get ConsequenceDescription() {

    const { root, section } = this.fieldRootInSection(`ConsequenceDescription_f`, `General`);
  ...
  get Consequence() {
    ...
    const { root, section } = this.fieldRootInSection(`Consequence_f`, `General`);
