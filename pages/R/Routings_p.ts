...
export class Routings_p extends DetailsPageBase {
  get RoutingCode() {

    const { root, section } = this.fieldRootInSection(`RoutingCode_f`, `General`);
  ...
  get _RoutingSteps() {
    ...
    const { root, section } = this.fieldRootInSection(`RoutingSteps_f`, `General`);
