...
export class GaugeRRStudyResults_p extends DetailsPageBase {
  get Appraiser() {
  ...
  get _AppraiserTrialExpression() {

    const { root, section } = this.fieldRootInSection(`AppraiserTrialExpression_f`, `General`);
  ...
  get MigrationID() {
    ...
    const { root, section } = this.fieldRootInSection(`MigrationID_f`, `General`);
