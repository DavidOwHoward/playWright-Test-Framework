...
export class PackagingCostItemsReturnable_p extends DetailsPageBase {
  ...
  get InitialInvestment() {
    ...
    const { root, section } = this.fieldRootInSection(`InitialInvestment_f`, `General`);
  ...
  get Numberofyearsinprogram() {

    const { root, section } = this.fieldRootInSection(`Numberofyearsinprogram_f`, `General`);
  ...
  get PackageCost() {
    ...
    const { root, section } = this.fieldRootInSection(`PackageCost_f`, `General`);
  ...
  get YearlyItemQuantitytoAmortizeover() {

    const { root, section } = this.fieldRootInSection(`YearlyItemQuantitytoAmortiz_f`, `General`);
