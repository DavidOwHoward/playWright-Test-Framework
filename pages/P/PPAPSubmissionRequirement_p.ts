...
export class PPAPSubmissionRequirement_p extends DetailsPageBase {
  get Sequence() {
  ...
  get SubmissionRequirement() {

    const { root, section } = this.fieldRootInSection(`SubmissionRequirement_f`, `General`);
