...
export class ProjectPhasesLibrary_p extends DetailsPageBase {
  get Phase() {
  ...
  get PhaseTasks() {
    ...
    const { root, section } = this.fieldRootInSection(`GateTasks_f`, `General`);
  ...
  get _ProjectTemplates() {
    ...
    const { root, section } = this.fieldRootInSection(`ProjectTypes_f`, `General`);
