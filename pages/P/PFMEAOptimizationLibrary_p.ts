...
export class PFMEAOptimizationLibrary_p extends DetailsPageBase {
  get ActionTakenwithPointertoEvidence() {

    const { root, section } = this.fieldRootInSection(`ActionsTakenandCompletionDa_f`, `General`);
  ...
  get ResponsibilityandTargetCompletionDate() {
    ...
    const { root, section } = this.fieldRootInSection(`ResponsibilityandTargetComp_f`, `General`);
  ...
  get DocumentChangeRequest() {

    const { root, section } = this.fieldRootInSection(`DocumentChangeRequest_f`, `General`);
