...
export class FMEAMSROptimizationLibrary_p extends DetailsPageBase {
  ...
  get _FMEAMSRCauseLibrary() {

    const { root, section } = this.fieldRootInSection(`FMEAMSRCauseLibrary_f`, `General`);
