...
export class FamilyPFMEAStructuralAnalysis_p extends DetailsPageBase {
  ...
  get ExistingProcessFlowCheck() {

    const { root, section } = this.fieldRootInSection(`ExistingProcessFlowCheck_f`, `General`);
  ...
  get ProcessFlow() {
    ...
    const { root, section } = this.fieldRootInSection(`SysProcessFlow_f`, `General`);
