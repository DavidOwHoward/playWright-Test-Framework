...
export class FMEAMSRFunctionalAnalysisLibrary_p extends DetailsPageBase {
  ...
  get _FMEAMSRFailureAnalysis() {

    const { root, section } = this.fieldRootInSection(`MSRFailureAnalysis_f`, `General`);
