...
export class FMEAActionPriority_p extends DetailsPageBase {
  get AbilitytoDetect() {
  ...
  get D() {
    ...
    const { root, section } = this.fieldRootInSection(`D_f`, `General`);
  ...
  get O() {
    ...
    const { root, section } = this.fieldRootInSection(`O_f`, `General`);
