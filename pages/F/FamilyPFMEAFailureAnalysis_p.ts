...
export class FamilyPFMEAFailureAnalysis_p extends DetailsPageBase {
  get LibraryDesign() {
  ...
  get AddNewOptimization() {

    const { root, section } = this.fieldRootInSection(`AddNewOptimization_f`, `General`);
  ...
  get PFMEAFailureAnalysisLibrary() {
    ...
    const { root, section } = this.fieldRootInSection(`LibraryFMEA_f`, `[Frozen Section]`);
  ...
  get Requirement() {
    ...
    const { root, section } = this.fieldRootInSection(`FTSpecification_f`, `General`);
  ...
  get _PotentialCauses() {
    ...
    const { root, section } = this.fieldRootInSection(`Causes_f`, `General`);
