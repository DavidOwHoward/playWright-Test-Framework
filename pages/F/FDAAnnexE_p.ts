...
export class FDAAnnexE_p extends DetailsPageBase {
  get CodeHierarchy() {
  ...
  get Level2Term() {
    ...
    const { root, section } = this.fieldRootInSection(`Level2Term_f`, `General`);
  ...
  get Level3Term() {
    ...
    const { root, section } = this.fieldRootInSection(`Level3Term_f`, `General`);
  ...
  get _NonIMDRFCode() {
    ...
    const { root, section } = this.fieldRootInSection(`NonIMDRFCode_f`, `General`);
  ...
  get PrimaryCategory() {
    ...
    const { root, section } = this.fieldRootInSection(`PrimaryCategory_f`, `General`);
  ...
  get SecondaryCategory() {
    ...
    const { root, section } = this.fieldRootInSection(`SecondaryCategory_f`, `General`);
