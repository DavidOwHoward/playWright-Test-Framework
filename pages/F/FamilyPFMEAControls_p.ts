...
export class FamilyPFMEAControls_p extends DetailsPageBase {
  get LibraryDesign() {
  ...
  get LibraryControl() {
    ...
    const { root, section } = this.fieldRootInSection(`PFMEALibraryControl_f`, `[Frozen Section]`);
  ...
  get _InspectionTypes() {
    ...
    const { root, section } = this.fieldRootInSection(`InspectionTypes_f`, `Sampling & Inspection`);
